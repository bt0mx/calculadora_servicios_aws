...
const NavBar = () => {
  ...
  const btnLink = 'block inline-block py-1 text-accent mr-4'
  //const activeLink = 'block inline-block py-1 text-accent mr-4'
  const activeLink = 'text-sky-600 block inline-block py-1 text-black hover:text-accent cursor-pointer mr-4'
  return(
